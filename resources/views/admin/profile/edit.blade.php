                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="form-check form-check-inline">
                                <input type="radio" class="form-check-input col-md-5" name="gender" value="man"{{ $profile_form->gender === "man" ? 'checked="checked"' : '' }}>
                                <label class="form-check-label" for="gender">男性</label> 
                            </div>
                             <div class="form-check form-check-inline">
                                <input type="radio" class="form-check-input col-md-5" name="gender" value="woman"{{ $profile_form->gender === "woman" ? 'checked="checked"' : '' }}>
